...
![7Facette CI](https://github.com/p7s1-ctf/SevenFacette/workflows/7Facette%20CI/badge.svg?branch=master)
...
```kotlin
implementation 'de.p7s1.qa.sevenfacette:core-jvm:0.1.1'
```

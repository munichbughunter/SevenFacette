...
import de.p7s1.qa.sevenfacette.veritas.NONE
import de.p7s1.qa.sevenfacette.veritas.Verify
import de.p7s1.qa.sevenfacette.veritas.fail
...
/**
 * Fails a verification with the given expected and actual values.
 */
fun <T> Verify<T>.fail(expected: Any?, actual: Any?) {
 ...
 */
fun <T> Verify<T>.expected(message: String, expected: Any? = NONE, actual: Any? = NONE): Nothing {
